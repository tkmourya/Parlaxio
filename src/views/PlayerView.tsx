...
export function PlayerView({ media, onBack, onPlay }: PlayerViewProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-transparent text-white overflow-y-auto hide-scrollbar animate-in fade-in duration-300">
      ...
      <div className="sticky top-0 left-0 right-0 z-[100] bg-black/50 backdrop-blur-2xl px-4 md:px-8 pt-[calc(env(safe-area-inset-top,0px)+0.625rem)] pb-2.5 flex items-center justify-between">
